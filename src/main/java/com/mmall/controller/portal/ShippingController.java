...
public class ShippingController {
    ...
    @ResponseBody
    public ServerResponse<Shipping> select(HttpSession session, Integer shippingId, HttpServletRequest httpServletRequest){
        /*User user = (User) session.getAttribute(Const.CURRENT_USER);*/
        /*不再从session当中获取用户，而是从cookie token当中*/
        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
        /*无法从cookie当中获取到loginToken，直接返回用户未登录*/
    ...
    @ResponseBody
    public ServerResponse<PageInfo> list(HttpSession session, HttpServletRequest httpServletRequest,
